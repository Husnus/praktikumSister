 ...
 * 
 */
public class Nomer3Thread_Boolean extends Thread {
    ...
    public static void main(String[] args) throws IOException {
        Nomer3Thread_Boolean counter = new Nomer3Thread_Boolean();
        counter.setThread(true);
        counter.start();
        Nomer3Thread_Boolean t = new Nomer3Thread_Boolean();
